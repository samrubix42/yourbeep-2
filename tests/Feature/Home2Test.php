...
test('home2 page hero section content is present', function () {
    $this->get('/')
        ->assertSee('Rewire Your Mind Through Games Without Meditation')
        ->assertSee('Affirmations or 21-Day Challenges')
        ->assertSee('science-backed behavioural intelligence system', false)
        ->assertSee('10 minutes a day', false)
        ->assertSee('Yourbeep is a science-backed gamified system', false)
